...
class YOSOFusionHead(BasePanopticFusionHead):
    """YOSO fusion head which postprocesses results for panoptic
    ...
    def loss(self, **kwargs):
        """YOSOFusionHead has no training loss."""
        return dict()
    ...
    def instance_postprocess(self, mask_cls: Tensor,
        ...
        num_proposals = mask_cls.shape[0]
        # shape (num_proposals, num_class)
        ...
        proposal_indices = top_indices // self.num_classes
        mask_pred = mask_pred[proposal_indices]
