# Source: https://github.com/Peterande/D-FINE/blob/4a1f73a8/src/nn/backbone/hgnetv2.py
# Modified by romiptr
...
class HGNetV2(nn.Module):
    def __init__(
        ...
        stem_channels = self.arch_cfg["stem_channels"]
        stage_config = self.arch_cfg["stage_config"]
...
def hgnetv2_b2(**kwargs):
    ...
    return HGNetV2(arch_cfg=arch_cfg, **kwargs)
